...
{$I-}
  ...
  begin
    ...
    begin
      ...
      begin
        MessageDlg('Невозможно сохранить опции (в ReadOnly файл)!',mtError,[mbok],0);
        exit;
      end else DoSet := true;
    end;
  end;
...
{    ini.WriteBool(NavigatorSection,'ConfEdtRO',ConfEdtRO);{}
    ...
    ini.WriteString(NavigatorSection,'SaveListLastDir',SaveListLastDir);
    ini.WriteString(NavigatorSection,'LoadListLastDir',LoadListLastDir);
    ini.WriteString(NavigatorSection,'SkinsPath',SkinsPath);
    ini.WriteString(NavigatorSection,'PlugsPath',PlugsPath);
